...
public class prueba_de_subacuatica_activity extends AppCompatActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.prueba_de_natacion_subacuatica);
	...
	public int funcionEtapasIniciales(int n) {
		if (m < 8) {
			...
			if (Distancia.getText().toString().isEmpty() ||
					...
					FCLPM.getText().toString().isEmpty()) {
			...
			String tiemerpicine = "Min";
			if (m == 7) {
				tiemerpicine = "Seg";
				EtapasIniciales[6][4] = 0; // o 9, según tu lógica original
			}

			String cambioHintFclp = (m >= 6) ? "Resultado 400 M. TECN.LC ."+ tiemerpicine : "FCLPM";
			//tecnica libre competencia
	...
	public void generarPdf(){
		...
		canvas.drawText("TEST ESTÁNDAR DE LACTATO PARA NATACION SUBACUATICA", 20, 30, paint);
		...
		Object[][] resultados = {
				...
				{"V4,km/h."                ,V4km    ,0          ,0      },
				{"V4;mph"                  ,V4mph    ,0         ,0      },
				{"RITMO/KM , DE V4, MIN."  ,RitmonKMMin    ,0	           ,0	    },
				{"RITMO/KM , DE V4, S."    ,RitmonKMS    ,0              ,0        }
		};
		...
		canvas.drawText("PRONOSTICO DE RESULTADO EN 400 M. NADO TECNICA LIBRE SEGÚN LA V4 VelMs: "+ VelMs + " Min: "+ EtapasIniciales[5][4] + " Seg: " + EtapasIniciales[6][4], startX, startY, paint);
		// Finaliza la página
		pdfDocument.finishPage(page);

		// Guarda el PDF en el almacenamiento externo
		String fileName = "Informe_Lactato_Subacuatica.pdf";
